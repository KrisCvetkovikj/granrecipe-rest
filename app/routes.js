...
routes.post("/users/me", authenticate, UsersController.update);
...
// Recipe
routes.get("/recipes", authenticate, RecipesController.search);
routes.get("/recipes/other", RecipesController.search);
routes.post("/recipes", authenticate, RecipesController.create);
routes.get("/recipes/:id", RecipesController._populate, RecipesController.fetch);
routes.delete("/recipes/:id", authenticate, RecipesController.delete);
